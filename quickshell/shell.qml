...
ShellRoot {
    ...
    property bool dateCenterVisible: false
    ...
    WG.Bar {
        ...
        onToggleSidebar: {
            ...
            root.dateCenterVisible = false;
        }
        onToggleDateCenter: {
            root.dateCenterVisible = !root.dateCenterVisible;
            root.sidebarVisible = false;
        }
    }
    WG.DateCenterPopup {
        visible: root.dateCenterVisible
        onRequestClose: root.dateCenterVisible = false
    }
    WG.Overlay {
        bgColor: root.systemColor
    }
