...
Item {
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: (data) => {
                return console.log("[Connect Out]: " + data);
            }
        }
        ...
        stderr: SplitParser {
            onRead: (data) => {
                ...
                // Capture errors
                if (data.includes("Secrets were required") || data.includes("802-11-wireless-security.psk") || data.includes("Error:"))
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: (data) => {
                return service.isEnabled = data.trim() === "enabled";
            }
        }
